...
ca_server: $(SRC_DIR)/ca_server.c $(OBJ_DIR)/pki_core.o
	$(CC) $(CFLAGS) -o $(BIN_DIR)/ca_server $(SRC_DIR)/ca_server.c $(OBJ_DIR)/pki_core.o

ra_issuer: $(SRC_DIR)/ra_issuer.c $(CORE_OBJ)
	$(CC) $(CFLAGS) -o $(BIN_DIR)/ra_issuer $(SRC_DIR)/ra_issuer.c $(OBJ_DIR)/pki_core.o

client_verify: $(SRC_DIR)/client_verify.c $(CORE_OBJ)
	$(CC) $(CFLAGS) -o $(BIN_DIR)/client_verify $(SRC_DIR)/client_verify.c $(OBJ_DIR)/pki_core.o
